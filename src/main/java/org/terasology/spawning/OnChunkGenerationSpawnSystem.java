...
@Share(value = OnChunkGenerationSpawnSystem.class)
@RegisterSystem(RegisterMode.AUTHORITY)
public class OnChunkGenerationSpawnSystem extends BaseComponentSystem {

    private static final Logger logger = LoggerFactory.getLogger(OnChunkGenerationSpawnSystem.class);
    ...
    public void onChunkGenerated(OnChunkGenerated event, EntityRef worldEntity) {
        // Only spawn the first prefab to meet probability
